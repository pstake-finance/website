            ...
            <div className="general-terms">
              ...
              <Table bordered>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{t("GENERAL_TITLE_TWO_THEAD_ROW_NINE")}</td>
                  </tr>
                </tbody>
              </Table>
              <p>{t("GENERAL_TITLE_ONE_SUB_THREE")}</p>
              <p className="sub-heading">{t("GENERAL_TITLE_THREE")}</p>
              <p>{t("GENERAL_TITLE_THREE_SUB_ONE")}</p>
              <p>{t("GENERAL_TITLE_THREE_SUB_TWO")}</p>
              <p>{t("GENERAL_TITLE_THREE_SUB_THREE")}</p>
              ...
              <ul>
                ...
                <li>
                  ...
                  <a href={IE_URL} rel="noopener noreferrer" target="_blank">
                    {t("GENERAL_TITLE_THREE_SUB_FOUR_LIST_FOUR_CONTINUE")}
                  </a>
                </li>
              </ul>
              <p className="sub-heading">{t("GENERAL_TITLE_FOUR")}</p>
              <p>{t("GENERAL_TITLE_FOUR_SUB_ONE")}</p>
              <p>{t("GENERAL_TITLE_FOUR_SUB_TWO")}</p>
              <p className="sub-heading">{t("GENERAL_TITLE_FIVE")}</p>
              <p>{t("GENERAL_TITLE_FIVE_SUB_ONE")}</p>
              <ul>
                <li>{t("GENERAL_TITLE_FIVE_LIST_ONE")}</li>
                <li>{t("GENERAL_TITLE_FIVE_LIST_TWO")}</li>
                <li>{t("GENERAL_TITLE_FIVE_LIST_THREE")}</li>
                <li>{t("GENERAL_TITLE_FIVE_LIST_FOUR")}</li>
                <li>{t("GENERAL_TITLE_FIVE_LIST_FIVE")}</li>
              </ul>
              <p>{t("GENERAL_TITLE_FIVE_SUB_TWO")}</p>
              <p className="sub-heading">{t("GENERAL_TITLE_SIX")}</p>
              <p>{t("GENERAL_TITLE_SIX_SUB_ONE")}</p>
              <ul>
                <li>{t("GENERAL_TITLE_SIX_SUB_ONE_LIST_ONE")}</li>
                <li>{t("GENERAL_TITLE_SIX_SUB_ONE_LIST_TWO")}</li>
                <li>{t("GENERAL_TITLE_SIX_SUB_ONE_LIST_THREE")}</li>
              </ul>
              <p>{t("GENERAL_TITLE_SIX_SUB_TWO")}</p>
              ...
              <p>{t("GENERAL_TITLE_NINE_SUB_ONE")}</p>
              <p>{t("GENERAL_TITLE_NINE_SUB_TWO")}</p>
            </div>
          </div>
        </div>
        <Footer />
