...
import TableHead from "../../components/molecules/table/table-head";
import TableBody from "../../components/molecules/table/table-body";
import { TableProps } from "../../components/molecules/table/types";
