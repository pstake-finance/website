...
const GoveranaceDropdown = ({ govList, isTablet }: Props) => {
  const router = useRouter();
  const { t } = useTranslation();
  return (
    <>
      <Dropdown
        overlay={governanceDropdownContent(govList)}
      ...
      <div className={"hidden md:!block "}>
        {governanceDropdownContent(govList)}
      </div>
    </>
  );
};
export default GoveranaceDropdown;
