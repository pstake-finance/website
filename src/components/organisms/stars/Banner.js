...
import { ATOM_URL, DYDX, OSMO_URL, STARS } from "../../../utils/config";
    ...
    <div className="text-center aos-init aos-animate bg-dydxBanner bg-no-repeat bg-[#FCFBFE]">
      ...
      >
        ...
        >
          ...
          <br /> STARS Liquid Staking
        </h1>
        <h6
          className="max-w-[700px] mx-auto mt-8 font-medium text-base
        text-[#393939] leading-loose sm:text-sm"
        >
          Liquid Stake STARS with 30+ dYdX validators to enjoy the best of both
          worlds—STARS staking rewards & stkSTARS DeFi opportunities.
        </h6>
        <div className="mt-8">
          <ButtonLink
