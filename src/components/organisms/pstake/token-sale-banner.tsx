...
const TokenSaleBanner = () => {
  ...
  return (
    <div className="bg-[#1B1B1B]  bg-tokenSaleBannerBg bg-no-repeat">
      <div className="container py-[60px] md:py-[35px]">
        <div
          className={"flex gap-3 max-w-[1140px] mx-auto md:block items-center"}
        >
            <p className="text-center text-[40px] lg:text-[24px] lg:leading-[40px] leading-[60px] font-semibold mb-0 text-[#FCFCFC]">
