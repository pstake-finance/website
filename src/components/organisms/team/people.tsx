...
const People = () => {
  ...
  return (
    <div
      className="bg-[#141414] aos-init aos-animate mb-[60px]"
    ...
    >
      <div className="max-w-[1220px] mx-auto  md:mx-4 pt-[170px] pb-[30px] lg:pb-[40px]">
        ...
        <div
          className={
            "grid grid-cols-2 gap-[60px] lg:gap-[30px]  lg:grid-cols-1"
          }
        >
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className={
                "flex gap-[24px] md:gap-[12px] md:flex-col md:items-center"
              }
            >
              ...
              <div className={"flex-1 md:text-center"}>
                <p
                  className={
                    "text-[#FEFEFE] font-semibold text-[22px] leading-[33px] mb-1"
                  }
                >
                  {member.name}
                </p>
                <p
                  className={
                    "text-[#F5F5F5] text-[14px] leading-[21px] mb-2 border-b border-[#FFFFFF26] pb-[6px]"
                  }
                >
                  {member.role}
                </p>
                <p className={"text-[#F5F5F5] text-[14px] leading-[21px] mb-5"}>
                  {member.info}
                </p>
