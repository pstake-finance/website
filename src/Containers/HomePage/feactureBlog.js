            ...
            <div className="container">
                ...
                <div className="col-md-4 blog-articles left">
                        <div className="row m-0">
                            ...
                            <a href="https://medium.com/@pstakefinance/pstake-mainnet-launch-beta-releasing-with-cosmos-atom-support-on-july-12th-d9a69d9fb6e5"
                                   target="_blank" rel="noopener noreferrer">
                                    <div className="custom-card mb-10" data-aos="fade-up">
                                        <div className="blog-image">
                                            <img className="card-img-top" alt="blog2"
                                                 src="https://miro.medium.com/max/1400/1*LJLKde50a10ZCzQuVzZgpw.png"/>
                                        </div>
